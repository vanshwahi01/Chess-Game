...
void Computer::randomPiece(Board& b, Colour curPlayer){//will this give me an error saying totalPieces is not declared in this scope? It technically comes with it because it's a player... but idk
